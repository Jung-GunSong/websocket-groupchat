...
class ChatUser {
  ...
  // handleMessage will use a specific method to create a joke,
  /** and send it back to the DOM
   * new method called "handleJoke"
   * handJoke will first pull a joke, from an array of jokes
   * (to start we can hard code one)
